...
# [2]: Oxford bus company. When2Travel. [Online]. Available at: https://www.oxfordbus.co.uk/covid-19/when-2-travel/. [Accessed 20th November 2020]
...
# Note: The number of trips was taken from Oxford Bus Company timetables
# Adding total distances travelled:
df_300 = df_300.assign(total_distance = [(df_300.iloc[0][1])*d_300*2,
...
df_300['total distance travelled'] = df_300['total_distance'].sum()   
...
# Note: The number of trips was taken from Oxford Bus Company timetables
# Adding total distances travelled:
df_400 = df_400.assign(total_distance = [(df_400.iloc[0][1])*d_400*2,
...
# Note: A factor of 2 is applied for distances to account for return trips
# Total distance traveled on a weekday:
df_400['total distance travelled'] = df_400['total_distance'].sum()   
...
# Note: The number of trips was taken from Oxford Bus Company timetables
# Adding total distances travelled:
df_500 = df_500.assign(total_distance = [(df_500.iloc[0][1])*d_500*2,
...
# Note: A factor of 2 is applied for distances to account for return trips
# Total distance traveled on a weekday:
df_500['total distance travelled'] = df_500['total_distance'].sum()   
...
# Note: The number of trips was taken from Oxford Bus Company timetables
# Adding total distances travelled:
df_S5 = df_S5.assign(total_distance = [(df_S5.iloc[0][1])*d_S5*2,
...
# Note: A factor of 2 is applied for distances to account for return trips
# Total distance traveled on a weekday:
df_S5['total distance travelled'] = df_S5['total_distance'].sum()   



# Total distance travelled:
total_distance = df_300.iloc[0][3]+df_400.iloc[0][3]+df_500.iloc[0][3]+df_S5.iloc[0][3]
